<template>
  ...
  >
    ...
    <!--
    <div
      class="absolute top-0 inset-x-0 p-2 transition transform origin-top-right md:hidden duration-150 ease-out opacity-100 scale-100"
    >
      <div
    ...
    <div class="w-48 hidden md:visible"></div>
  </div>
</template>